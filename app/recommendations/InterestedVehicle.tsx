...
const InterestedVehicle: React.FC = () => {
  ...
  useEffect(() => {
    const fetchRecommendations = async () => {
      setLoading(true); // Start loading animation when fetching begins
      ...
      try {
        ...
        setRecommendedVehicles(data || []); // Update with fetched data
      } catch (err) {
        console.error("Error fetching recommendations:", err);
      } finally {
        setLoading(false); // Stop loading after fetch (successful or error)
      }
    };
